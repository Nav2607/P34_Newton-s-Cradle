...
function setup() {
	...
	sling1 = new Sling(pendulum1.body, { x: 300, y: 250 }); 
	sling2 = new Sling(pendulum2.body, { x: 350, y: 250 }); 
	sling3 = new Sling(pendulum3.body, { x: 400, y: 250 }); 
	sling4 = new Sling(pendulum4.body, { x: 450, y: 250 }); 
	sling5 = new Sling(pendulum5.body, { x: 500, y: 250 }); 
